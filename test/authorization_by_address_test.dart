...
main() async {
  ...
  test("Test send on permitted address", () async {
    try {
      eventBus = await EventBus.create(eventbusAddress, consumerExecDelegate: Zone.current.runGuarded);
      AsyncResult result = await eventBus.sendWithReplyAsync("permitted");
  ...
  test("Test send on not permitted address", () async {
